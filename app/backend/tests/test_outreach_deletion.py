...
def test_outreach_delete_is_owned_and_returns_success() -> None:
    ...
    try:
        ...
        response = client.delete(
            "/api/v1/outreach-items/00000000-0000-0000-0000-000000000001"
        )
        assert response.status_code == 200
        assert response.json() == {
            "deleted": True,
            "outreach_item_id": "00000000-0000-0000-0000-000000000001",
        }
...
def test_outreach_delete_hides_missing_or_other_users_item() -> None:
    ...
    try:
        response = TestClient(app).delete(
            "/api/v1/outreach-items/00000000-0000-0000-0000-000000000002"
        )
